...
function mensaje(){
    alert ("Nota: Para las funciones trigonométicas y los logaritmos primero escribir el número y después dar click en el botón de la función.");
}
function binario(){
    var b=x.toString(2);
    pantalla.innerHTML=b;
    x=0; //Borrado indicador número pantalla.
    coma=0;	//reiniciamos también la coma			
